...
def dashboard():
    if current_user.role == 'student':
        ...
        return render_template('dashboard_teacher.html', leaves=leaves, filtered_leaves=leaves, stats=stats, students=[], selected_student=None, student_leave_count=0, category_labels=[], category_counts=[])
    else:
...
def requests_view():
    ...
    return render_template('dashboard_teacher.html', leaves=leaves, filtered_leaves=filtered_leaves, stats=stats, students=students, selected_student=selected_student, student_leave_count=student_leave_count, category_labels=category_labels, category_counts=category_counts, requested_labels=requested_labels, requested_counts=requested_counts)
